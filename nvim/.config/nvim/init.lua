...
vim.cmd("highlight MsgArea guibg=black guifg=lightgray")
...
vim.keymap.set(
	"n",
	"<leader><space>",
	":Neotree source=buffers position=float reveal<cr>",
	{ desc = "Neotree Show Buffers" }
)
vim.keymap.set("n", "<leader>f", ":Neotree reveal position=left toggle=true<cr>", { desc = "Neotree" })
